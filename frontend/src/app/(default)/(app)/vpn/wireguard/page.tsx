    ...
    return (
      <div className="flex items-center justify-center h-48">
        <div className="text-center space-y-3">
          ...
          <p className="text-sm text-muted-foreground">Loading WireGuard configuration...</p>
        </div>
      </div>
    );
  }
          ...
          <div className="p-3 border-b border-border">
            <div className="flex items-center justify-between mb-2">
              <div className="flex items-center gap-2">
                ...
                <h2 className="text-sm font-semibold">WireGuard</h2>
              </div>
              <Button
                variant="ghost"
                size="icon"
                    ...
                    <div>
                      <div className="flex items-center gap-2">
                        ...
                        {currentInterface.disabled && (
                          <Badge variant="secondary" className="text-xs bg-amber-500/10 text-amber-600 gap-1">
                  ...
                  <div className="rounded-lg border border-border card-accent p-3">
                    <div className="flex items-center gap-2">
                      ...
                      <div>
                        ...
                        <p className="text-sm font-semibold">{currentInterface.port || "Auto"}</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="rounded-lg border border-border card-accent p-3">
                    <div className="flex items-center gap-2">
                      ...
                      <div>
                        ...
                        <p className="text-sm font-semibold">{currentInterface.peer_count}</p>
                      </div>
                    </div>
                  </div>
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          {loadingPublicKey ? (
                            ...
                            <div className="flex items-center gap-2">
                              <code className="text-xs font-mono bg-muted px-2 py-1 rounded max-w-[500px] truncate">
                                {publicKey}
                              </code>
                              <button
                            ...
                            <span className="text-xs text-muted-foreground">Unable to retrieve public key</span>
                          )}
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="p-4">
                    {filteredPeers.length === 0 ? (
                      <div className="text-center py-8">
                        ...
                        <p className="text-sm font-medium text-foreground mb-1">No Peers</p>
                        <p className="text-xs text-muted-foreground mb-3">
                            ...
                            {filteredPeers.map((peer) => {
                              ...
                              return (
                                <TableRow key={peer.name} className="group">
                                  ...
                                  <TableCell>
                                    {peer.disabled ? (
                                      <Badge variant="secondary" className="text-xs bg-red-500/10 text-red-600 gap-1">
                                        <XCircle className="h-3 w-3" />
                                        Disabled
                                      </Badge>
                                    ) : (
