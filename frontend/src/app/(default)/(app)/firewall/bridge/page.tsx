        ...
        <div className="w-64 border-r border-border bg-card/50 flex flex-col h-full">
          <div className="p-3">
            <div className="flex items-center gap-2 mb-4">
              ...
              <div>
                <h1 className="text-sm font-semibold text-foreground">Bridge Firewall</h1>
            ...
            {/* Version Notice */}
            {!isV15 && capabilities && (
              <div className="bg-amber-500/10 border border-amber-500/20 rounded-md px-2 py-1.5 mb-3">
                      ...
                      <div className="space-y-0.5">
                        {customChains.map((chain) => (
                          <div
                            key={chain.name}
                            className={cn(
                              "group flex items-center justify-between px-2 py-2 rounded-md text-sm transition-all",
          ...
          <div className="border-b border-border bg-card/50 px-4 py-3">
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-2">
                ...
                <Button size="sm" onClick={() => setCreateModalOpen(true)} disabled={hasChanges}>
            ...
            {/* Alerts */}
            {successMessage && (
              <div className="bg-green-500/10 border border-green-500/20 rounded-md px-3 py-1.5 flex items-center gap-2 mt-3">
                <CheckCircle2 className="h-4 w-4 text-green-500" />
                <p className="text-sm text-green-600 dark:text-green-400">{successMessage}</p>
              </div>
            )}
            {error && (
              <div className="bg-destructive/10 border border-destructive/20 rounded-md px-3 py-1.5 flex items-center gap-2 mt-3">
            ...
            <div className="flex items-center gap-3 mt-3">
              ...
              <div className="flex items-center gap-2 ml-auto">
                <span className="text-xs text-muted-foreground">Default Action:</span>
                <Select
                ...
                <Table className="table-dense">
                  ...
                  <TableBody>
                    {filteredRules.length === 0 ? (
                      <TableRow>
                        <TableCell colSpan={isV15 ? 8 : 7} className="h-24">
