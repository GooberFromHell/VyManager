          ...
          <Tabs defaultValue="basic" className="w-full">
            ...
            <TabsContent value="basic" className="space-y-4">
              <Fieldset label="Inbound Interface">
                <RadioGroup value={inboundInterfaceType} onValueChange={(v) => setInboundInterfaceType(v as "name" | "group")} className="flex gap-4">
            ...
            <TabsContent value="source" className="space-y-4">
              <Fieldset label="Source">
                <RadioGroup value={sourceType} onValueChange={(v) => setSourceType(v as "address" | "group")} className="flex gap-4">
                  <div className="flex items-center space-x-2">
            ...
            <TabsContent value="destination" className="space-y-4">
              <Fieldset label="Destination">
                <RadioGroup value={destinationType} onValueChange={(v) => setDestinationType(v as "address" | "group")} className="flex gap-4">
                  <div className="flex items-center space-x-2">
