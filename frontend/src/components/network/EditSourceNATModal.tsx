        ...
        <div className="space-y-4 py-4">
          ...
          <Tabs defaultValue="basic" className="w-full">
            ...
            <TabsContent value="basic" className="space-y-4">
              <Fieldset label="Outbound Interface">
                <FormField label="Interface Type">
                  <RadioGroup value={outboundInterfaceType} onValueChange={(v) => setOutboundInterfaceType(v as "name" | "group")}>
                    <div className="flex items-center space-x-2">
                      ...
                      <label htmlFor="outbound-name" className="text-sm cursor-pointer">Interface Name</label>
                    </div>
                    <div className="flex items-center space-x-2">
                      <RadioGroupItem value="group" id="outbound-group" />
                      <label htmlFor="outbound-group" className="text-sm cursor-pointer">Interface Group</label>
                    </div>
                  </RadioGroup>
                </FormField>

                {outboundInterfaceType === "name" ? (
                  <FormField label="Outbound Interface Name" htmlFor="outbound-interface-name">
                  ...
                  <FormField label="Outbound Interface Group" htmlFor="outbound-interface-group">
              ...
              <Fieldset label="Translation">
                <FormField label="Translation Type">
                  <RadioGroup value={translationType} onValueChange={(v) => setTranslationType(v as "ip" | "cidr" | "range" | "masquerade")}>
                    <div className="flex items-center space-x-2">
                      ...
                      <label htmlFor="trans-masquerade" className="text-sm cursor-pointer">Masquerade (use outbound interface address)</label>
                    </div>
                    <div className="flex items-center space-x-2">
                      <RadioGroupItem value="ip" id="trans-ip" />
                      <label htmlFor="trans-ip" className="text-sm cursor-pointer">IP Address</label>
                    </div>
                    <div className="flex items-center space-x-2">
                      <RadioGroupItem value="cidr" id="trans-cidr" />
                      <label htmlFor="trans-cidr" className="text-sm cursor-pointer">CIDR Block</label>
                    </div>
                    <div className="flex items-center space-x-2">
                      <RadioGroupItem value="range" id="trans-range" />
                      <label htmlFor="trans-range" className="text-sm cursor-pointer">IP Range</label>
                    </div>
                  </RadioGroup>
                </FormField>
                ...
                {translationType !== "masquerade" && (
                  <FormField
                    label={`Translation Address${translationType === "cidr" ? " (e.g., 192.168.1.0/24)" : translationType === "range" ? " (e.g., 192.168.1.10-192.168.1.20)" : " (e.g., 203.0.113.10)"}`}
              ...
              <Fieldset>
                <FormField
                  label="Protocol"
                  htmlFor="protocol"
                  description={(sourcePort.trim() || destinationPort.trim()) ? "Only TCP/UDP protocols are available when using ports" : undefined}
                >
