        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <Fieldset label="Basic">
            <FormField
              ...
              description="Example: eth0, eth1, eth2"
              required
            >
              <Input
                id="interface-name"
          ...
          {(capabilities?.features.ethernet.speed || capabilities?.features.ethernet.duplex || capabilities?.features.basic.mtu || capabilities?.features.basic.vrf) && (
            <>
              <FieldsetDivider />
          ...
          {capabilities?.features.basic.disable && (
            <>
              <FieldsetDivider />
              <Fieldset>
                <FormField label="Disabled" htmlFor="disable" horizontal>
                  <Checkbox
                    id="disable"
                    checked={disabled}
