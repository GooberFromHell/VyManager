...
import { ChevronRightIcon, FolderIcon, FileIcon, DownloadIcon, TrashIcon } from "lucide-react"
...
function TreeItem({
        ...
        <CollapsibleTrigger asChild>
          ...
          >
            <ItemMedia variant="icon">
              <ChevronRightIcon aria-hidden="true" className="text-muted-foreground size-3 transition-transform in-data-[state=open]:rotate-90" />
              <FolderIcon aria-hidden="true" className="text-muted-foreground group-hover/item:text-foreground size-3.5" />
            </ItemMedia>
  ...
  return (
    ...
    >
      <ItemMedia variant="icon">
        <FileIcon aria-hidden="true" className="text-muted-foreground group-hover/item:text-foreground group-data-[active=true]/item:text-foreground size-4" />
      </ItemMedia>
