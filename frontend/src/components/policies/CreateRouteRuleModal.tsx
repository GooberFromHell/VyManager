            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-6">
                ...
                <div className="space-y-4">
                  ...
                  <FormField label="Source MAC Group (optional)" htmlFor="sourceMacGroup">
                  ...
                  <FormField label="Source Port Group (optional)" htmlFor="sourcePortGroup">
                ...
                <div className="space-y-4">
                  ...
                  <FormField label="Destination MAC Group (optional)" htmlFor="destMacGroup">
                  ...
                  <FormField label="Destination Port Group (optional)" htmlFor="destPortGroup">
