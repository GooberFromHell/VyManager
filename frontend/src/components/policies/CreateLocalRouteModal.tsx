        ...
        <div className="space-y-4 py-4">
          ...
          <Fieldset label="Match Conditions">
            <FormField
              ...
              htmlFor="source"
              description="Match traffic from this source (optional)"
            >
              <Input
                id="source"
                value={source}
            ...
            <FormField
              ...
              htmlFor="destination"
              description="Match traffic to this destination (optional)"
            >
              <Input
                id="destination"
                value={destination}
            ...
            <FormField
              ...
              description="Match traffic arriving on this interface (optional)"
            >
