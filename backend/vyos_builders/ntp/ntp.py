...
class NTPBatchBuilder:
    ...
    def get_capabilities(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "fields": {
                "server": {"supported": True, "description": "NTP server addresses"},
                "listen_address": {"supported": True, "description": "Addresses to listen on for clients"},
                "allow_client": {"supported": True, "description": "Networks allowed to query"},
                "vrf": {"supported": True, "description": "VRF to use"},
                "leap_second": {"supported": True, "description": "Leap second handling mode"},
                "noselect": {"supported": True, "description": "Mark server as noselect"},
                "nts": {"supported": True, "description": "Enable NTS for server"},
                "pool": {"supported": True, "description": "Mark server as pool"},
                "prefer": {"supported": True, "description": "Mark server as preferred"},
                "ptp": {"supported": is_v15, "description": "PTP server option (v1.5+)"},
                "interleave": {"supported": is_v15, "description": "Interleave mode (v1.5+)"},
            },
        }
